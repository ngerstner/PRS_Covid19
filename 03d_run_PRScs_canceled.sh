...
#cohort=("Omni_Sep2017_PhaseIII/bggt_info06/omni_samples_info06_hwe_maf_bggt")
#cohort=("MARS_GSK_610K_550K_PhaseIII/bggt_info06/550k610k_samples_info06_maf_hwe_bggt")
cohort=("BeCome_SIA_Dec2019/bggt_info0.6/07_bestguess/probabilities_info0.6/become_dec2019_all")
#cohort_short=("BeCome" "MARS_GSK")
cohort_short=("MARS_BeCome")
ncohort=${#cohort[@]}
