...
/binder/mgp/code/plink2/plink2 --score "/binder/mgp/datasets/2020_PRS_Covid19/GWAS_sumstats/${traits[$itrait]}/${cohort_short[$icohort]}_all_chromosomes.txt" 2 4 6 --out "/binder/mgp/datasets/2020_PRS_Covid19/GWAS_sumstats/${traits[$itrait]}/${cohort_short[$icohort]}_plink_out_woFlip" --bfile "/binder/common/genotypes/qc_imputations/${cohort[$icohort]}"
