...
#traits=( $(cut -f8 /binder/mgp/datasets/2020_GWAS_Covid19/GWAS_summaries.tsv | tail -n +2) )
traits=("SCZ")
ntraits=${#traits[@]}
...
cat /binder/mgp/datasets/2020_GWAS_Covid19/${traits[$itrait]}/${cohort_short[$icohort]}/* > /binder/mgp/datasets/2020_GWAS_Covid19/${traits[$itrait]}/${cohort_short[$icohort]}_all_chromosomes.txt

#run PLINK2 to calculate overall risk of each individual in cohorts for the different diseases/traits
/binder/mgp/code/plink2/plink2 --score "/binder/mgp/datasets/2020_GWAS_Covid19/${traits[$itrait]}/${cohort_short[$icohort]}_all_chromosomes.txt" 2 4 6 --out "/binder/mgp/datasets/2020_GWAS_Covid19/${traits[$itrait]}/${cohort_short[$icohort]}_plink_out.txt" --bfile "/binder/common/genotypes/qc_imputations/${cohort[$icohort]}"
